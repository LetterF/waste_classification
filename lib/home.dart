...
class _HomeState extends State<Home> {
  ...
  runModel()async{
    if(cameraImage!=null){
      ...
      imageHeight: cameraImage!.height, imageWidth: cameraImage!.width,
      imageMean: 127.5, imageStd: 127.5, rotation: 90, numResults: 2,
      threshold: 0.1, asynch: true);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:Text("Household Waste Classification App"),
